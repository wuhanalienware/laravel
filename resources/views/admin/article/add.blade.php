...
{{--                    百度富文本编辑权--}}
                <div class="layui-input-block">
                    ...
                    <script id="editor" type="text/plain" name="art_content" style="width:1200px;height:700px;"></script>
                    ...
                    $.ajax({
                        ...
                        success: function(data){
                            if(data['ServerNo']=='200'){
                                ...
                                $('input[name=art_thumb]').val('http://q5dfb3q9t.bkt.clouddn.com/'+data['ResultData']);
                                //原始方法
