<!-- /.Footer Nav Wrap -->
<script type="text/javascript" src="<?php echo e(asset('home/js/zh-cn-tw.js')); ?>"></script>
...
<script type="text/javascript" src="<?php echo e(asset('home/js/theme.js?ver=4.3.6')); ?>"></script>
<!-- /.Footer -->
<script type="text/javascript">
