<header class="header-wrap" id="nav-scroll">
    ...
    <?php if(session('homeuser')): ?>
        <!-- Login status -->
            ...
            <!-- Login status -->
            <div id="login-reg">
                <span> <a href="#"><?php echo e(session('homeuser')->user_name); ?></a></span>
            </div>
            <!-- /.Login status -->
        ...
        <nav id="primary-navigation" class="site-navigation primary-navigation " role="navigation">
            <div class="menu-%e9%a1%b6%e9%83%a8%e8%8f%9c%e5%8d%95-container">
                <ul id="menu-%e9%a1%b6%e9%83%a8%e8%8f%9c%e5%8d%95" class="nav-menu">
                    ...
                    <?php $__currentLoopData = $cateone; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-has-children menu-item-4316"><a href="<?php echo e(url('/lists/'.$v->cate_id)); ?>"><?php echo e($v->cate_name); ?></a>
                        <?php if(!empty($catetwo[$k])): ?>
                        <ul class="sub-menu">
                            <?php $__currentLoopData = $catetwo[$k]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m=>$n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-4317"><a href="<?php echo e(url('/lists/'.$n->cate_id)); ?>"><?php echo e($n->cate_name); ?></a></li>
